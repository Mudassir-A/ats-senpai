...
class ATSAnalyzer:
    @staticmethod
    def get_gemini_response(api_key, input_prompt, pdf_text, job_description):
        try:
        ...
        if st.button("Analyze Resume"):
            with st.spinner("Analyzing your resume ... Please wait"):
                ...
                if pdf_text:
                    ...
                    # display response
                    response = ATSAnalyzer.get_gemini_response(
                        api_key, prompt, pdf_text, job_description
                    )
            ...
            st.info(
                "👆 Please enter your Google API Key, upload your resume, and provide the job description to begin the analysis."
            )
